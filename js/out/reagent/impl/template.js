...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6663__auto__,writer__6664__auto__,opt__6665__auto__){
return cljs.core._write.call(null,writer__6664__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__6065__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__6065__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__6065__auto__)){
return or__6065__auto__;
} else {
...
var G__12367 = o;
(G__12367[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_12371 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_12371))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12371)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__6053__auto__ = (node === document.activeElement);
if(and__6053__auto__){
var and__6053__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__6053__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__12374 = jsprops;
(G__12374["defaultValue"] = value);

(G__12374["onChange"] = ((function (G__12374,v,value,on_change){
return (function (p1__12372_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12372_SHARP_);
});})(G__12374,v,value,on_change))
);
...
var vec__12376 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12376,(0),null);
var id = cljs.core.nth.call(null,vec__12376,(1),null);
var class$ = cljs.core.nth.call(null,vec__12376,(2),null);
...
var temp__4659__auto__ = (function (){var G__12380 = cljs.core.meta.call(null,v);
if((G__12380 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__12380);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__12382_12383 = v;
var G__12382_12384__$1 = (((G__12382_12383 == null))?null:reagent.impl.template.key_from_vec.call(null,G__12382_12383));
if((G__12382_12384__$1 == null)){
} else {
(jsprops["key"] = G__12382_12384__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__12387 = cljs.core.meta.call(null,argv);
if((G__12387 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__12387);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__12388 = (((jsprops == null))?{}:jsprops);
(G__12388["key"] = key);
...
var G__12389 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12389;
continue;
}
} else {
...
var n__6968__auto___12390 = a.length;
var i_12391 = (0);
while(true){
if((i_12391 < n__6968__auto___12390)){
(a[i_12391] = reagent.impl.template.as_element.call(null,(a[i_12391])));
...
var a = cljs.core.into_array.call(null,s);
var n__6968__auto___12393 = a.length;
var i_12394 = (0);
while(true){
if((i_12394 < n__6968__auto___12393)){
var val_12395 = (a[i_12394]);
if((cljs.core.vector_QMARK_.call(null,val_12395)) && ((reagent.impl.template.key_from_vec.call(null,val_12395) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12394] = reagent.impl.template.as_element.call(null,val_12395));

var G__12396 = (i_12394 + (1));
i_12394 = G__12396;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__6053__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__6053__auto__){
return (ctx["no-key"]);
} else {
return and__6053__auto__;
...
var G__12398 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12398) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12398){
