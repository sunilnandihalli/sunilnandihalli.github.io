...
var or__6065__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__6065__auto__)){
return or__6065__auto__;
} else {
var or__6065__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__6065__auto____$1)){
return or__6065__auto____$1;
} else {
var or__6065__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__6065__auto____$2)){
return or__6065__auto____$2;
} else {
var or__6065__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__6065__auto____$3)){
return or__6065__auto____$3;
} else {
...
var n__6968__auto__ = a.length;
var i = (0);
while(true){
if((i < n__6968__auto__)){
var c_12303 = (a[i]);
if(cljs.core.truth_((c_12303["cljsIsDirty"]))){
(c_12303["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__6663__auto__,writer__6664__auto__,opt__6665__auto__){
return cljs.core._write.call(null,writer__6664__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__12307 = c;
var G__12307__$1 = (((G__12307 == null))?null:(G__12307["props"]));
if((G__12307__$1 == null)){
return null;
} else {
return (G__12307__$1["argv"]);
}
});
...
var G__12309_12310 = (c["cljsRatom"]);
if((G__12309_12310 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__12309_12310);
}
